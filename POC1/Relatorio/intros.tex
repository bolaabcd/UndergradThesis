...
% https://ieeexplore.ieee.org/abstract/document/9007737 (Explainable Machine Learning for Scientific Insights and Discoveries): 

% https://www.frontiersin.org/journals/big-data/articles/10.3389/fdata.2021.688969/full (Principles and Practice of Explainable Machine Learning): 

% https://www.jair.org/index.php/jair/article/view/12228 (A Survey on the Explainability of Supervised Machine Learning): 

% https://www.mdpi.com/2079-9292/8/8/832 (Machine Learning Interpretability: A Survey on Methods and Metrics): 

% https://link.springer.com/article/10.1007/s13347-019-00372-9 (Against Interpretability: a Critical Examination of the Interpretability Problem in Machine Learning):

% https://dl.acm.org/doi/pdf/10.1145/3236386.3241340 (The mythos of model interpretability: In machine learning, the concept of interpretability is both important and slippery): 
