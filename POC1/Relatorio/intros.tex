...
% https://arxiv.org/pdf/1806.00069 (Explaining Explanations: An Overview of Interpretability of Machine Learning) - More philosofical introduction, explain vs interpret, it might not be good to hear only humans as we might make persuasive instead of good explanations, it might be unethical to oversimplify just to get more acceptance, the tradeoff between interpretability and its completeness can be seen not only as a balance between simplicity and accuracy in a proxy model. The tradeoff can also be made by anchoring explanations to substitute tasks or evaluating explanations in terms of their ability to surface important model biases

% https://www.mdpi.com/1099-4300/23/1/18 (Explainable AI: A Review of Machine Learning Interpretability Methods): Goals, local vs global, model-specific vs model-agnostic.

% https://ieeexplore.ieee.org/abstract/document/9007737 (Explainable Machine Learning for Scientific Insights and Discoveries): Transparency (the designer can explain why such a model, distance metrics, etc. were selected, between the model and the developer) vs Interpretability (what exaclty does the model bases its decision on??? Uses proxy simpler models such as linear models, decision trees, etc. or visual approachs such as heatmaps, dimensionality reduction, etc., between the model and the data). This paper discusses how explainability can be used to enhance scientific research in natural sciences and provides some examples in the literature.

% https://www.frontiersin.org/journals/big-data/articles/10.3389/fdata.2021.688969/full (Principles and Practice of Explainable Machine Learning): This one provides important and clear distincts between different approaches, who cares and what exactly they care about. It provides a very good division of approaches, I prefer this one to the previous one, although the previous one is more focused on natural science applications. I THINK I PREFER THIS ONE!

% https://www.jair.org/index.php/jair/article/view/12228 (A Survey on the Explainability of Supervised Machine Learning): This ones lists some nice reasons to develop explainability, and domains where this can be applied. It also lists extra types of interpretable ML models. It also provides alternative divisions of the user of the explanation. It also talks about ontology and ontologies as if it was a concrete thing... Might be interesting, seems to be a way to formalize knowledge sharing...

% https://www.mdpi.com/2079-9292/8/8/832 (Machine Learning Interpretability: A Survey on Methods and Metrics): this one lists interesting properties of individual explanations such as fidelity and others. It is very big, so I think we can use just this part. Maybe the part where it mentions fairness, privacy, and other possible uses of explainability...

% https://link.springer.com/article/10.1007/s13347-019-00372-9 (Against Interpretability: a Critical Examination of the Interpretability Problem in Machine Learning): They say interpretability doesn't make sense in the context of ML algorithms, and we can solve our problems without it, as it is always a means to an end we are restricting ourselves if we enforce that this should be an mean, we could solve directly the end.

% https://dl.acm.org/doi/pdf/10.1145/3236386.3241340 (The mythos of model interpretability: In machine learning, the concept of interpretability is both important and slippery): this one also points out that linear models for instance are not necessarily better, as they might rely on un-interpretable and heavily-engineered features. They also point out other things to look out for when working with explainability.
