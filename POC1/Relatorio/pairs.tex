...
\begin{enumerate}
\item \cite{Causality} {\color{red} AQUI}
...
\item \cite{The Impossibility Theorem of Machine Fairness: a Causal Perspective} . This paper was found in \url{arxiv.org}.{\color{red} AQUI}
\item \cite{Identifiability of Causal-based ML Fairness Notions} compiles major identifiability results from the identifiability{\color{red} AQUI}
\end{enumerate}
