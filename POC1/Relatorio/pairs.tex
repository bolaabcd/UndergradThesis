...
\item \cite{Does Explainable Artificial Intelligence Improve Human Decision-Making?} provides an empirical study on whether explanations for AI predictions do or do not improve the accuracy of human decision-making, and the results indicate that this might not be the case.
