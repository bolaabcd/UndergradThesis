...
\hline
Exploring LDP noise reversal &&&&&&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&&&&&& \\
\hline
Preparing Partial Pitch &&&&&&&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&&&&&& \\
\hline
Exploring privacy bidget distribution &&&&&&&&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&&&& \\
\hline
Exploring $(\epsilon,\delta)-DP$ modeling with $QIF$ &&&&&&&&&&&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}&\cellcolor[HTML]{00EEEE}& \\
\hline
